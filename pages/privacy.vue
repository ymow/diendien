<template>
  <div>
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Donzz LLC, 3F., No.22, Ln. 295, Sec. 1, Dunhua S. Rd.,, Da’an
          Dist..</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to diendien, accessible from <a href="http://www.diendien.com"
                                                                           rel="external nofollow noopener"
                                                                           target="_blank">http://www.diendien.com</a></p>
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a
            href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener" target="_blank">https://www.google.com/intl/en/policies/privacy/</a>
        </p>
      </li>
    </ul>
    ...
    <ul>
      <li>By email: kenshin0812@hotmail.com</li>
    </ul>
  </div>
</template>
